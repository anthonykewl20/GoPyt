...
This implements the manual main-only signing workflow, consumer identity checks,
and source/artifact withdrawal policy. It does not yet claim a successful signed
end-to-end run or complete #23's component/adaptation inventory.
